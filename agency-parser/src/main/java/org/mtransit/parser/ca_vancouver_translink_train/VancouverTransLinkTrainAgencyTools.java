...
public class VancouverTransLinkTrainAgencyTools extends DefaultAgencyTools {
	...
	public Integer getOriginalAgencyRouteType() {
		return MAgency.ROUTE_TYPE_SUBWAY; // classified as subway instead of light rail
	}
	...
	private static final Pattern SKY_TRAIN_LINE_TO = Pattern.compile("((skytrain )?(- platform sign )?(\\w* line )?to )", Pattern.CASE_INSENSITIVE);
	...
	public String cleanTripHeadsign(@NotNull String tripHeadsign) {
		...
		tripHeadsign = SKY_TRAIN_LINE_TO.matcher(tripHeadsign).replaceAll(EMPTY);
